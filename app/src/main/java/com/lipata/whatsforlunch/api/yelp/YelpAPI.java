...
public class YelpAPI {
   ...
   */
  private static final String CONSUMER_KEY = ApiKeys.CONSUMER_KEY;
  private static final String CONSUMER_SECRET = ApiKeys.CONSUMER_SECRET;
  private static final String TOKEN = ApiKeys.TOKEN;
  private static final String TOKEN_SECRET = ApiKeys.TOKEN_SECRET;
